defmodule Chess.Moves.Generator do
  @moduledoc """
  Génère des mouvements pour une pièce. Nous pouvons générer des mouvements en ligne droite,
   et ceux-ci peuvent être combinés pour faire des mouvements de pièces entières. Ou on
   peut générer des mouvements basés sur un modèle de vecteurs. Le chevalier fonctionne
   comme ça.
  """
